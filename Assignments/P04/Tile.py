...
class Tile(pygame.sprite.Sprite):
    def __init__(self, img, rect, index):
        ...
        self.__barriers = [3,5,6,35,38,66,67,99,163,165,166,167,169,181,198,213,233,225,226,228,257,258,259,260,261,291,292,293,297,310,323,324,342,356,357,361,390,391,425,450,451,452,453,482,483,484,485,489,628,659]
